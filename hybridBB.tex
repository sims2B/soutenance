...
\pgfplotstableread[row sep=\\,col sep=&]{
  act.  & tps(s) & solv. & tps & solved\\ 
    20 & 20 &100&7.0&100 \\ 
      25 & 219.5&100&54.15 &100  \\ 
      30 & 2108.6&75&94.85&100 \\ 
}\mydat
  \begin{frame}
    \frametitle{Computational results} 
\begin{center}
\begin{tikzpicture}
      \begin{axis}[ enlarge x limits=0.25,
        ...
        width=\textwidth,
        height=.6\textwidth,
        symbolic x coords={10,20,25,30},
        xtick=data,
        ymin=0,ymax=2500,
        ylabel={\small $times (s)$},
        xlabel={\small $\#tasks$}]
        \addplot table[x=act.,y=tps(s)]{\mydat};
        \addplot table[x=act.,y=tps]{\mydat};
        \legend{On/Off model, Hybrid BB}
      \end{axis}
    \end{tikzpicture}
  \end{center}
    % \begin{figure}[!htb]

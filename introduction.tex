...
\begin{frame}{Preemptive/Non-preemptive schedule}
  In the right fig., execution of taks $k$ is paused at $t=3$ and
  restart at $t=5$.
  \vspace{-1.8cm}
  \begin{columns}
...
\begin{frame}
  ...
  \vspace{0.3cm}
  A required energy quantity ( [resource $\times$ time]) is associated to a task.
